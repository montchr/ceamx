...
(use-package meow
  ...
  (defun ceamx-meow-setup ()
    "Configure meow keybindings."

    ;; (def-hook! +meow-toggle-normal-mode-h ()
    ;;   '(magit-blame-mode-hook view-mode-hook)
    ;;   "Toggle `meow-normal-mode'."
  ...
  ;; TODO: evaluate -- i think i prefer this, but need a refresher
