...
(custom-set-variables
 ...
 '(package-selected-packages
   '(activities aggressive-indent auto-tangle-mode bookmark-in-project
                ...
                consult-notmuch corfu crux cursory cycle-quotes devdocs
                diff-hl dired-preview dired-subtree diredfl doct
                doric-themes dotenv-mode drag-stuff dumb-jump easy-kill
                eat edit-indirect ef-themes elfeed-goodies elfeed-org
                elfeed-score elfeed-tube-mpv elisp-demos embark-consult
                emmet-mode envrc eros exec-path-from-shell exiftool
                expreg fish-mode flycheck-eglot flycheck-phpstan
                fontaine free-keys git-commit-ts-mode git-modes
                git-timemachine gnu-elpa-keyring-update gnugo go
                golden-ratio gptel haskell-mode haskell-ts-mode
                help-find helpful hl-todo hledger-mode htmlize ialign
                indent-bars jinx jq-mode just-ts-mode kanata-kbd-mode
                kbd-mode kdl-ts-mode keycast keymap-utils kind-icon
                ledger-mode ligature lin lispy macrostep magit
                marginalia markdown-ts-mode mines minions mlscroll
                modus-themes morlock mugur mwim neon-mode
                ...
                pandoc-mode pdf-tools polymode popper prism pulsar puni
                ...
                svg-tag-mode systemd tempel tmr transpose-frame
